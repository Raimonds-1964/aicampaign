      ...
      <main style={{ ...pageInner, fontFamily: "Arial, sans-serif" }}>
        ...
        {showTop && (
          <>
            ...
            {plan === "FREE" && (
              <div style={{ marginTop: 14, fontSize: 13, fontWeight: 900, color: remainingToday <= 1 ? "#b91c1c" : "#334155" }}>
              ...
              {plan === "PRO" && modelToShowSafe ? (
                ...
                <RightSideBlurLock text={overlayText}>
                  <GoogleLikeAdCard
                    model={generated}
                    allowSelect={false}
                    onCopyBlock={() => setError("Demo režīmā kopēšana ir atslēgta. Lai atbloķētu, izveido kampaņu.")}
                  />
                </RightSideBlurLock>
              )}
            </div>
