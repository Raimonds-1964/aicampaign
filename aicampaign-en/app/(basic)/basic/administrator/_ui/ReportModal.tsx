...
export default function ReportModal({
  ...
  const groups = useMemo(
    () => [
      {
        title: "Campaigns",
        items: ["Budget", "Status", "Impression Share", "Spend", "Clicks"],
      },
      {
        title: "Keywords",
        items: ["Top %", "Page 1 %", "CTR", "CPC", "Search Terms"],
      },
      {
        title: "Ads",
        items: ["RSA Strength", "Assets", "CTR", "Conversions"],
      },
    ],
    []
  );
  ...
  function onFromChange(v: string) {
    // If from > to, move "to" along with it
    setFrom(v);
      ...
      >
        ...
        <div className="max-h-[70vh] overflow-auto p-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            {/* Custom range: simple calendar via 2 date inputs */}
            {preset === "custom" && (
