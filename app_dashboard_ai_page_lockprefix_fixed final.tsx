                  ...
                  <div style={{ display: "grid", gap: 12 }}>
                    ...
                    <div style={{ display: "grid", gap: 10 }}>
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 4 }}>
                        ...
                        >
                          {lockPrefix}{lang === "en" ? "Copy CSV (Keywords)" : "Kopēt CSV (atslēgvārdi)"}
                        </button>
                        ...
                        >
                          {lockPrefix}{lang === "en" ? "Copy CSV (Ads + Sitelinks)" : "Kopēt CSV (teksti + sitelinki)"}
                        </button>
                        ...
                        >
                          {lockPrefix}{lang === "en" ? "Download CSV (Full)" : "Lejupielādēt CSV (viss)"}
                        </button>
                      </div>
                    ...
                    <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 2 }}>
                      ...
                      >
                        {lockPrefix}{lang === "en" ? "Copy full campaign" : "Kopēt visu kampaņu"}
                      </button>
                      ...
                      >
                        {lockPrefix}{lang === "en" ? "Copy ad texts" : "Kopēt reklāmas tekstus"}
                      </button>
                    </div>
                  </div>
                </div>
