          ...
          <>
            ...
            {plan === "FREE" && (
              <div style={{ marginTop: 14, fontSize: 13, fontWeight: 700, color: remainingToday <= 0 ? "#dc2626" : "#6b7280" }}>
                FREE: {remainingToday} / {dailyLimit} ģenerācijas palikušas šodien{remainingToday === 1 ? " — Pēdējā ģenerācija šodien" : remainingToday === 0 ? " — Limits sasniegts šodien" : ""}
              </div>
            )}
                  ...
                  <div style={{ display: "grid", gap: 12 }}>
                    ...
                    <div style={{ display: "grid", gap: 10 }}>
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 4 }}>
                        ...
                        >
                          {plan === "FREE" ? (lang === "en" ? "🔒 Copy CSV (Keywords)" : "🔒 Kopēt CSV (atslēgvārdi)") : (lang === "en" ? "Copy CSV (Keywords)" : "Kopēt CSV (atslēgvārdi)")}
                        </button>
                        ...
                        >
                          {plan === "FREE" ? (lang === "en" ? "🔒 Copy CSV (Ads + Sitelinks)" : "🔒 Kopēt CSV (teksti + sitelinki)") : (lang === "en" ? "Copy CSV (Ads + Sitelinks)" : "Kopēt CSV (teksti + sitelinki)")}
                        </button>
                        ...
                        >
                          {plan === "FREE" ? (lang === "en" ? "🔒 Download CSV (Full)" : "🔒 Lejupielādēt CSV (viss)") : (lang === "en" ? "Download CSV (Full)" : "Lejupielādēt CSV (viss)")}
                        </button>
                      </div>
                    ...
                    <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 2 }}>
                      ...
                      >
                        {plan === "FREE" ? (lang === "en" ? "🔒 Copy full campaign" : "🔒 Kopēt visu kampaņu") : (lang === "en" ? "Copy full campaign" : "Kopēt visu kampaņu")}
                      </button>
                      ...
                      >
                        {plan === "FREE" ? (lang === "en" ? "🔒 Copy ad texts" : "🔒 Kopēt reklāmas tekstus") : (lang === "en" ? "Copy ad texts" : "Kopēt reklāmas tekstus")}
                      </button>
                    </div>
                  </div>
                </div>
