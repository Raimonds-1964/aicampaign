  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <div className="text-2xl font-semibold text-white/90">Kampaņas</div>
          <div className="mt-2 text-white/60"></div>

          {/* ===== Kontu filtrs (header) ===== */}
          <div className="mt-4 flex flex-wrap items-center gap-2">
            {/* ❌ NOŅEMTS: "Konts: ..." čips. Kontu filtrs (select) paliek. */}
      ...
      <div className={card}>
        <div className="border-b border-white/10 p-5">
          <div className="text-base font-semibold text-white/90">Visas kampaņas</div>
          ...
          <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-3">
            ...
            <div className="text-sm text-white/50 md:justify-self-end md:self-center">
              Kopā:{" "}
              <span className="font-semibold text-white/80">{filteredCampaigns.length}</span>
            </div>
          </div>
        </div>
                  ...
                  <tr key={c.id} className="border-b border-white/5 last:border-b-0">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-2">
                        <Link
                          className={btn}
                          href={`/pro/administrator/konti/${c.accountId}/kampanas/${c.id}`}
                        >
                          Detaļas →
                        </Link>
