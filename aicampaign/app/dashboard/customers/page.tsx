...
export default function CustomersPage() {
  ...
  return (
    <div className="w-full">
      <h1 className="mt-0 text-2xl font-semibold">Google Ads konti</h1>

      <p className="mt-2 text-slate-600">
        Ja redzi <b>CUSTOMER_NOT_ENABLED</b>, tas nozīmē, ka konkrētais Ads konts nav aktivizēts
        (nav pabeigts billing iestatījums). Izvēlies citu kontu vai aktivizē šo Google Ads UI.
      </p>
      ...
      <div className="mt-6">
        <h3 className="mb-3 text-lg font-semibold">Pieejamie konti</h3>

        {customers.length === 0 ? (
          <div className="text-slate-500">Nav ielādētu kontu.</div>
        ) : (
      ...
      {raw && (
        <div className="mt-6">
          <h3 className="mb-3 text-lg font-semibold">API atbilde (debug)</h3>
