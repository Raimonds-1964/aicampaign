...
export default function Client() {
  ...
  function handleResetAll() {
    setDraft(null);
    // Wizard pats notīra savus laukus ar iekšējo Notīrīt,
    // bet mums vajag notīrīt arī rezultātu.
  }
    ...
    <div className="min-h-screen w-full bg-black text-white">
      <div className="mx-auto w-full max-w-6xl px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="mt-2 text-4xl font-semibold">AI kampaņas veidotājs</h1>
          <p className="mt-2 text-white/60">
            Ievadi mājaslapas URL un saņem Search kampaņas struktūru.
          </p>
        </div>
