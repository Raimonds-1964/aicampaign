...
function clampToLimits(state: Pick<AgencyState, "limits" | "accounts" | "campaigns">) {
  ...
  // Basic: max 5 kampaņas (vienam kontam)
...
function buildDemoCampaigns(accountId: string, kind: "ai" | "own"): Campaign[] {
  ...
  const prefix = kind === "ai" ? "AI" : "Mans";

  return [
    {
      id: `${kind}-c-101`,
      accountId,
      name: `${prefix} Brand — Meklēšana`,
      status: "active",
      health: 86,
    ...
    },
    {
      id: `${kind}-c-102`,
      accountId,
      name: `${prefix} Search — Pakalpojumi`,
      status: "active",
      health: 72,
    ...
    },
    {
      id: `${kind}-c-103`,
      accountId,
      name: `${prefix} Search — Augstas intensitātes atslēgvārdi`,
      status: "paused",
      health: 64,
    ...
    },
    {
      id: `${kind}-c-104`,
      accountId,
      name: `${prefix} Search — Konkurentu vaicājumi`,
      status: "active",
      health: 48,
    ...
    },
    {
      id: `${kind}-c-105`,
      accountId,
      name: `${prefix} Remarketing — Atgriezt apmeklētājus`,
      status: "active",
      health: 79,
...
export const useAgencyStore = create<AgencyState>((set, get) => {
  ...
  // ✅ Startā var būt demo konts + 5 kampaņas (kā tu prasīji “kā bija”)
  const initialAccounts: Account[] = [
    { id: "acc-1", name: "SIA Example (LV)", googleAdsUrl: "https://ads.google.com/" },
  ];
  ...
  return {
    ...
    addOwnAccount: () => {
      ...
      const next = {
        ...get(),
        accounts: [{ id: accountId, name: "Mans konts", googleAdsUrl: "https://ads.google.com/" }],
    ...
    addAiAccount: () => {
      ...
      const next = {
        ...get(),
        accounts: [{ id: accountId, name: "AI konts", googleAdsUrl: "https://ads.google.com/" }],
