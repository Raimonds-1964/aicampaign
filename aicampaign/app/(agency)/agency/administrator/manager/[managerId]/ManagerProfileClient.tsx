...
export default function ManagerProfileClient() {
  ...
  const title = isAdminProfile
    ? "Administrator"
    : manager?.name ?? "Nezināms manager";
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-6">
      ...
      <div className={card}>
                  ...
                  <tr key={c.id} className="border-b border-white/5 last:border-b-0">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex justify-end gap-2">
                        ...
                        {/* ✅ Noņemt tikai manager profilā (ne Admin profilā) */}
                        {!isAdminProfile ? (
                          <button
                            className={btn}
                            type="button"
        ...
        <div className="px-5 py-3 text-xs text-white/45">
          Statuss: tikai indikators. Budžets: tikai % (spent/dailyBudget).
        </div>
      </div>
