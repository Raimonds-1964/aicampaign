...
export default function CampaignParamCard(props: {
  ...
  function setAiEnabledPersist(v: boolean) {
    ...
    try {
      window.dispatchEvent(new CustomEvent("agency:ai-toggle", { detail: { storageKey, value } }));
    } catch {}
  }
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Toggle checked={aiEnabled} onChange={setAiEnabledPersist} label={aiEnabled ? "AI: ieslēgts" : "AI: izslēgts"} />
            </div>

            {/* ✅ PRASĪBA: ja AI izslēgts -> nerādām NEKO (summary/aiSuggestion) */}
            {aiEnabled ? (
              <>
          ...
          {/* ✅ PRASĪBA: ja AI izslēgts -> slēpjam pogas/cta */}
          {aiEnabled ? (
          ...
          >
            ...
            <div className="max-h-[70vh] overflow-auto p-4">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="mt-2 text-sm text-white/60">Atzīmē, ko izpildīt. (Demo)</div>
            ...
            <div className="flex items-center justify-end gap-2 border-t border-white/10 px-4 py-3">
              ...
              <button type="button" onClick={approveSelected} className="rounded-lg bg-white px-3 py-2 text-sm text-black hover:opacity-90">
                Apstiprināt
              </button>
            </div>
          </div>
