...
export type Campaign = {
  ...
  dailyBudget: number;
  spentToday: number;
  ownerId: string; // ADMIN_OWNER_ID vai managerId
  keywords?: KeywordRow[];
};
      ...
      campaigns: [
        {
          ...
          spentToday: 26.4,
          keywords: [
            { keyword: "google ads aģentūra", page1: 0.72, top: 0.31, clicks: 12, cost: 6.4, note: "Labs" },
            { keyword: "ppc pārvaldība", page1: 0.48, top: 0.18, clicks: 7, cost: 8.1, note: "Jāuzlabo" },
            { keyword: "reklāma google", page1: 0.22, top: 0.05, clicks: 3, cost: 4.9, note: "Dārgi" },
          ],
        },
        {
          id: "c-102",
          ...
          spentToday: 10.2,
          keywords: [
            { keyword: "pakalpojumi rīga", page1: 0.66, top: 0.24, clicks: 18, cost: 9.6, note: "OK" },
            { keyword: "profesionāli pakalpojumi", page1: 0.41, top: 0.11, clicks: 6, cost: 7.3, note: "Jāuzlabo" },
          ],
        },
        {
          id: "c-201",
          ...
          dailyBudget: 60,
          spentToday: 41.5,
          keywords: [{ keyword: "ecom brand", page1: 0.58, top: 0.17, clicks: 25, cost: 21.4, note: "Jāuzlabo" }],
        },
        {
          id: "c-202",
          ...
          dailyBudget: 15,
          spentToday: 0,
          keywords: [{ keyword: "konkurents x", page1: 0.21, top: 0.06, clicks: 1, cost: 1.2, note: "Test" }],
        },
        {
          id: "c-301",
          name: "Search - Riga",
          ...
          dailyBudget: 20,
          spentToday: 7.3,
          keywords: [{ keyword: "zobārsts rīga", page1: 0.63, top: 0.19, clicks: 9, cost: 5.2, note: "OK" }],
        },
        {
          id: "c-401",
      ...
      campaigns: [
        {
          ...
          spentToday: 5.2,
          keywords: [
            { keyword: "sia example", page1: 0.81, top: 0.44, clicks: 19, cost: 5.2, note: "Stabils" },
          ],
        },
        {
          id: "c-502",
          name: "Search - Lead Gen (LV)",
          ownerId: "m2",
          status: "active",
          health: "warning",
          dailyBudget: 35,
          spentToday: 24.1,
          keywords: [
            { keyword: "pakalpojums cena", page1: 0.39, top: 0.12, clicks: 11, cost: 12.8, note: "Jāuzlabo" },
            { keyword: "piedāvājums rīga", page1: 0.44, top: 0.14, clicks: 8, cost: 11.3 },
          ],
        },
        {
          id: "c-503",
...
// Ja gribi *resetot* demo datus ar koda palīdzību:
...
export const agencyActions = {
  ...
  /** Back-compat: piešķir visas konta kampaņas */
  ...
  /** Back-compat: noņem visas konta kampaņas */
  ...
  /**
   * ✅ Pēc noklusējuma ļaujam tikai 1 kontu.
   * Ja vajag “nopirkt klāt” (demo) – ieliec localStorage atslēgu:
  ...
  addAiAccount() {
    ...
    const acc: Account = { id: makeId("acc"), name: "AI Account", campaigns: [] };
  ...
  /** Neierobežoti: pievieno jaunu kampaņu kontam */
