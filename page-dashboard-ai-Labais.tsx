...
export default function AiPage() {
  ...
  const manualTextAll = useMemo(() => {
    ...
    // Paraugs: rādām tikai dažas rindas (aizmiglots), lai saprastu formātu.
  ...
  function openUpgradePaywall(reason?: string) {
    ...
    setPaywall({
      ...
      text:
        lang === "en"
          ? "Izvēlies plānu to copy, edit, and export your campaign."
                ...
                >
                  ...
                  >
                    <div style={{ padding: 14 }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                        <div style={{ fontWeight: 900, color: "#0f172a" }}>Manuālais režīms (paraugs)</div>
                        <div
                          style={{
                            padding: "6px 10px",
                            borderRadius: 999,
                      ...
                      <div style={{ marginTop: 6, color: "#475569", fontWeight: 700, fontSize: 13, lineHeight: 1.35 }}>
                        Šeit redzi formātu. Kopēšana / eksports pieejams pēc plāna izvēles.
                      </div>
