...
export default function AiPage() {
  ...
  const remainingNote = useMemo(() => {
    if (plan !== "FREE") return "";
    if (remainingToday <= 0) return lang === "en" ? "— Limit reached today" : "— Limits sasniegts šodien";
    if (remainingToday === 1) return lang === "en" ? "— Last one today" : "— Pēdējā ģenerācija šodien";
    return "";
  }, [plan, remainingToday, lang]);
          ...
          <>
            ...
            {plan === "FREE" && (
              <div style={{ marginTop: 14, fontSize: 13, fontWeight: 700, color: remainingToday <= 0 ? "#dc2626" : "#6b7280" }}>
                FREE: {remainingToday} / {dailyLimit} ģenerācijas palikušas šodien {remainingNote ? ` ${remainingNote}` : ""}
              </div>
            )}
                  ...
                  <div style={{ display: "grid", gap: 12 }}>
                    ...
                    <div style={{ display: "grid", gap: 10 }}>
                      ...
                      <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                        ...
                        >
                          {`${plan === "FREE" ? "🔒 " : ""}${lang === "en" ? "Copy keywords" : "Kopēt atslēgvārdus"}`}
                        </button>
                      </div>
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 4 }}>
                        ...
                        >
                          {`${plan === "FREE" ? "🔒 " : ""}${lang === "en" ? "Copy CSV (Keywords)" : "Kopēt CSV (atslēgvārdi)"}`}
                        </button>
