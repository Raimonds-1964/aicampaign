...
export default function PricingPage() {
  ...
  const plans: Plan[] = useMemo(
    () => [
      ...
      },
      {
        ...
        highlights: ["Līdz 3 AI kampaņām mēnesī", "Eksports (PDF / CSV)", "Pārskati + pamat-analītika"],
        features: [
      ...
      },
      {
        ...
        highlights: ["Līdz 10 AI kampaņām mēnesī", "Detalizēta analītika + ieteikumi", "Konversijas ieteikumi mājaslapai"],
        features: [
      ...
      },
      {
        ...
        outcome: "Vienots standarts 10–200+ kontiem: struktūra, pārvaldība un komandas darbs vienuviet.",
        highlights: ["Neierobežotas kampaņas", "MCC / vairāki konti", "Komanda + klientu pārvaldība"],
        features: [
  ...
  function displayPrice(plan: Plan) {
    ...
    // yearly vizuāli, bet Stripe plāns ir yearly priceId (cits planKey)
    const yearly = plan.price * 12 * (1 - yearlyDiscount);
    return { primary: `${formatEUR(yearly)}`, secondary: "/ gadā" };
  }

  // ✅ galvenais: map UI plan + billing -> Stripe planKey
  ...
  return (
    <Container style={{ paddingTop: 46, paddingBottom: 70, fontFamily: "Arial, sans-serif", color: "#0f172a" }}>
      <main>
        {/* ✅ TopBar noņemts šeit, lai nebūtu dubultā (ja TopBar jau ir layoutā) */}
        ...
        >
          ...
          <div style={{ marginTop: 14, color: "#475569", fontWeight: 800 }}>30 dienu garantija — 100% atmaksa</div>
        </section>
          ...
          {plans.map((p) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ marginTop: 10, color: "#334155", fontWeight: 900, fontSize: 13 }}>{p.forWho}</div>
                ...
                <details style={{ marginTop: 10 }}>
                  <summary style={{ cursor: "pointer", color: "#2563eb", fontWeight: 900 }}>Skatīt visas detaļas</summary>
